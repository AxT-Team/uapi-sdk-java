...
public class Markdown {
  ...
  public Markdown code(@javax.annotation.Nullable String code) {
    this.code = code;
    return this;
  }
  ...
  public Markdown message(@javax.annotation.Nullable String message) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, markdown.code) &&
        Objects.equals(this.message, markdown.message);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to Markdown
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!Markdown.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in Markdown is not found in the empty JSON string", Markdown.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!Markdown.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `Markdown` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
