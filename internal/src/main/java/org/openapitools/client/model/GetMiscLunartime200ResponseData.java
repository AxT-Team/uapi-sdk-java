...
public class GetMiscLunartime200ResponseData {
  ...
  public GetMiscLunartime200ResponseData() {
  }

  public GetMiscLunartime200ResponseData queryTimestamp(@javax.annotation.Nullable String queryTimestamp) {
  ...
  public GetMiscLunartime200ResponseData queryTimezone(@javax.annotation.Nullable String queryTimezone) {
  ...
  public GetMiscLunartime200ResponseData timezone(@javax.annotation.Nullable String timezone) {
  ...
  public GetMiscLunartime200ResponseData datetime(@javax.annotation.Nullable String datetime) {
  ...
  public GetMiscLunartime200ResponseData datetimeRfc3339(@javax.annotation.Nullable String datetimeRfc3339) {
  ...
  public GetMiscLunartime200ResponseData timestampUnix(@javax.annotation.Nullable Integer timestampUnix) {
  ...
  public GetMiscLunartime200ResponseData weekday(@javax.annotation.Nullable String weekday) {
  ...
  public GetMiscLunartime200ResponseData weekdayCn(@javax.annotation.Nullable String weekdayCn) {
  ...
  public GetMiscLunartime200ResponseData lunarYear(@javax.annotation.Nullable Integer lunarYear) {
  ...
  public GetMiscLunartime200ResponseData lunarMonth(@javax.annotation.Nullable Integer lunarMonth) {
  ...
  public GetMiscLunartime200ResponseData lunarDay(@javax.annotation.Nullable Integer lunarDay) {
  ...
  public GetMiscLunartime200ResponseData isLeapMonth(@javax.annotation.Nullable Boolean isLeapMonth) {
  ...
  public GetMiscLunartime200ResponseData lunarYearCn(@javax.annotation.Nullable String lunarYearCn) {
  ...
  public GetMiscLunartime200ResponseData lunarMonthCn(@javax.annotation.Nullable String lunarMonthCn) {
  ...
  public GetMiscLunartime200ResponseData lunarDayCn(@javax.annotation.Nullable String lunarDayCn) {
  ...
  public GetMiscLunartime200ResponseData ganzhiYear(@javax.annotation.Nullable String ganzhiYear) {
  ...
  public GetMiscLunartime200ResponseData ganzhiMonth(@javax.annotation.Nullable String ganzhiMonth) {
  ...
  public GetMiscLunartime200ResponseData ganzhiDay(@javax.annotation.Nullable String ganzhiDay) {
  ...
  public GetMiscLunartime200ResponseData zodiac(@javax.annotation.Nullable String zodiac) {
    this.zodiac = zodiac;
    return this;
  }
  ...
  public GetMiscLunartime200ResponseData solarTerm(@javax.annotation.Nullable String solarTerm) {
  ...
  public GetMiscLunartime200ResponseData lunarFestivals(@javax.annotation.Nullable List<String> lunarFestivals) {
    this.lunarFestivals = lunarFestivals;
    return this;
  }

  public GetMiscLunartime200ResponseData addLunarFestivalsItem(String lunarFestivalsItem) {
  ...
  public GetMiscLunartime200ResponseData solarFestivals(@javax.annotation.Nullable List<String> solarFestivals) {
    this.solarFestivals = solarFestivals;
    return this;
  }

  public GetMiscLunartime200ResponseData addSolarFestivalsItem(String solarFestivalsItem) {
  ...
  public boolean equals(Object o) {
    ...
    GetMiscLunartime200ResponseData getMiscLunartime200ResponseData = (GetMiscLunartime200ResponseData) o;
    return Objects.equals(this.queryTimestamp, getMiscLunartime200ResponseData.queryTimestamp) &&
        Objects.equals(this.queryTimezone, getMiscLunartime200ResponseData.queryTimezone) &&
        Objects.equals(this.timezone, getMiscLunartime200ResponseData.timezone) &&
        Objects.equals(this.datetime, getMiscLunartime200ResponseData.datetime) &&
        Objects.equals(this.datetimeRfc3339, getMiscLunartime200ResponseData.datetimeRfc3339) &&
        Objects.equals(this.timestampUnix, getMiscLunartime200ResponseData.timestampUnix) &&
        Objects.equals(this.weekday, getMiscLunartime200ResponseData.weekday) &&
        Objects.equals(this.weekdayCn, getMiscLunartime200ResponseData.weekdayCn) &&
        Objects.equals(this.lunarYear, getMiscLunartime200ResponseData.lunarYear) &&
        Objects.equals(this.lunarMonth, getMiscLunartime200ResponseData.lunarMonth) &&
        Objects.equals(this.lunarDay, getMiscLunartime200ResponseData.lunarDay) &&
        Objects.equals(this.isLeapMonth, getMiscLunartime200ResponseData.isLeapMonth) &&
        Objects.equals(this.lunarYearCn, getMiscLunartime200ResponseData.lunarYearCn) &&
        Objects.equals(this.lunarMonthCn, getMiscLunartime200ResponseData.lunarMonthCn) &&
        Objects.equals(this.lunarDayCn, getMiscLunartime200ResponseData.lunarDayCn) &&
        Objects.equals(this.ganzhiYear, getMiscLunartime200ResponseData.ganzhiYear) &&
        Objects.equals(this.ganzhiMonth, getMiscLunartime200ResponseData.ganzhiMonth) &&
        Objects.equals(this.ganzhiDay, getMiscLunartime200ResponseData.ganzhiDay) &&
        Objects.equals(this.zodiac, getMiscLunartime200ResponseData.zodiac) &&
        Objects.equals(this.solarTerm, getMiscLunartime200ResponseData.solarTerm) &&
        Objects.equals(this.lunarFestivals, getMiscLunartime200ResponseData.lunarFestivals) &&
        Objects.equals(this.solarFestivals, getMiscLunartime200ResponseData.solarFestivals);
  }
   ...
   * @throws IOException if the JSON Element is invalid with respect to GetMiscLunartime200ResponseData
   */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      if (jsonElement == null) {
        if (!GetMiscLunartime200ResponseData.openapiRequiredFields.isEmpty()) { // has required fields but JSON element is null
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The required field(s) %s in GetMiscLunartime200ResponseData is not found in the empty JSON string", GetMiscLunartime200ResponseData.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Map.Entry<String, JsonElement> entry : entries) {
        if (!GetMiscLunartime200ResponseData.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format(Locale.ROOT, "The field `%s` in the JSON string is not defined in the `GetMiscLunartime200ResponseData` properties. JSON: %s", entry.getKey(), jsonElement.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GetMiscLunartime200ResponseData.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GetMiscLunartime200ResponseData' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GetMiscLunartime200ResponseData> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GetMiscLunartime200ResponseData.class));

       return (TypeAdapter<T>) new TypeAdapter<GetMiscLunartime200ResponseData>() {
           @Override
           public void write(JsonWriter out, GetMiscLunartime200ResponseData value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public GetMiscLunartime200ResponseData read(JsonReader in) throws IOException {
  ...
  /**
   * Create an instance of GetMiscLunartime200ResponseData given an JSON string
   *
   * @param jsonString JSON string
   * @return An instance of GetMiscLunartime200ResponseData
   * @throws IOException if the JSON string is invalid with respect to GetMiscLunartime200ResponseData
   */
  public static GetMiscLunartime200ResponseData fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GetMiscLunartime200ResponseData.class);
  }

  /**
   * Convert an instance of GetMiscLunartime200ResponseData to an JSON string
   *
   * @return JSON string
   */
