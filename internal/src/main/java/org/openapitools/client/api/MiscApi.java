...
public class MiscApi {
     ...
     * @param excludePast 传 true 时，会过滤今天之前已经过去的节日。默认 false。 (optional, default to false)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call getMiscHolidayCalendarCall(@javax.annotation.Nullable String date, @javax.annotation.Nullable String month, @javax.annotation.Nullable String year, @javax.annotation.Nullable String timezone, @javax.annotation.Nullable String holidayType, @javax.annotation.Nullable Boolean includeNearby, @javax.annotation.Nullable Integer nearbyLimit, @javax.annotation.Nullable Boolean excludePast, final ApiCallback _callback) throws ApiException {
        ...
        if (excludePast != null) {
            localVarQueryParams.addAll(localVarApiClient.parameterToPair("exclude_past", excludePast));
        }
    ...
    private okhttp3.Call getMiscHolidayCalendarValidateBeforeCall(@javax.annotation.Nullable String date, @javax.annotation.Nullable String month, @javax.annotation.Nullable String year, @javax.annotation.Nullable String timezone, @javax.annotation.Nullable String holidayType, @javax.annotation.Nullable Boolean includeNearby, @javax.annotation.Nullable Integer nearbyLimit, @javax.annotation.Nullable Boolean excludePast, final ApiCallback _callback) throws ApiException {
        return getMiscHolidayCalendarCall(date, month, year, timezone, holidayType, includeNearby, nearbyLimit, excludePast, _callback);
     ...
     */
    public GetMiscHolidayCalendar200Response getMiscHolidayCalendar(@javax.annotation.Nullable String date, @javax.annotation.Nullable String month, @javax.annotation.Nullable String year, @javax.annotation.Nullable String timezone, @javax.annotation.Nullable String holidayType, @javax.annotation.Nullable Boolean includeNearby, @javax.annotation.Nullable Integer nearbyLimit, @javax.annotation.Nullable Boolean excludePast) throws ApiException {
        ApiResponse<GetMiscHolidayCalendar200Response> localVarResp = getMiscHolidayCalendarWithHttpInfo(date, month, year, timezone, holidayType, includeNearby, nearbyLimit, excludePast);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<GetMiscHolidayCalendar200Response> getMiscHolidayCalendarWithHttpInfo(@javax.annotation.Nullable String date, @javax.annotation.Nullable String month, @javax.annotation.Nullable String year, @javax.annotation.Nullable String timezone, @javax.annotation.Nullable String holidayType, @javax.annotation.Nullable Boolean includeNearby, @javax.annotation.Nullable Integer nearbyLimit, @javax.annotation.Nullable Boolean excludePast) throws ApiException {
        okhttp3.Call localVarCall = getMiscHolidayCalendarValidateBeforeCall(date, month, year, timezone, holidayType, includeNearby, nearbyLimit, excludePast, null);
     ...
     */
    public okhttp3.Call getMiscHolidayCalendarAsync(@javax.annotation.Nullable String date, @javax.annotation.Nullable String month, @javax.annotation.Nullable String year, @javax.annotation.Nullable String timezone, @javax.annotation.Nullable String holidayType, @javax.annotation.Nullable Boolean includeNearby, @javax.annotation.Nullable Integer nearbyLimit, @javax.annotation.Nullable Boolean excludePast, final ApiCallback<GetMiscHolidayCalendar200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMiscHolidayCalendarValidateBeforeCall(date, month, year, timezone, holidayType, includeNearby, nearbyLimit, excludePast, _callback);
        Type localVarReturnType = new TypeToken<GetMiscHolidayCalendar200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param limit 搜索模式下最大返回条数，默认 50，最大 200。 (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> 查询成功！返回指定平台的热榜列表数据。不同模式返回格式不同：默认模式和时光机模式返回 list 数组；搜索模式返回 results 数组。 </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getMiscHotboardCall(@javax.annotation.Nonnull String type, @javax.annotation.Nullable Long time, @javax.annotation.Nullable String keyword, @javax.annotation.Nullable Long timeStart, @javax.annotation.Nullable Long timeEnd, @javax.annotation.Nullable Integer limit, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMiscHotboardValidateBeforeCall(@javax.annotation.Nonnull String type, @javax.annotation.Nullable Long time, @javax.annotation.Nullable String keyword, @javax.annotation.Nullable Long timeStart, @javax.annotation.Nullable Long timeEnd, @javax.annotation.Nullable Integer limit, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'type' is set
        if (type == null) {
            throw new ApiException("Missing the required parameter 'type' when calling getMiscHotboard(Async)");
        }

        return getMiscHotboardCall(type, time, keyword, timeStart, timeEnd, limit, _callback);
     ...
     */
    public GetMiscHotboard200Response getMiscHotboard(@javax.annotation.Nonnull String type, @javax.annotation.Nullable Long time, @javax.annotation.Nullable String keyword, @javax.annotation.Nullable Long timeStart, @javax.annotation.Nullable Long timeEnd, @javax.annotation.Nullable Integer limit) throws ApiException {
        ApiResponse<GetMiscHotboard200Response> localVarResp = getMiscHotboardWithHttpInfo(type, time, keyword, timeStart, timeEnd, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetMiscHotboard200Response> getMiscHotboardWithHttpInfo(@javax.annotation.Nonnull String type, @javax.annotation.Nullable Long time, @javax.annotation.Nullable String keyword, @javax.annotation.Nullable Long timeStart, @javax.annotation.Nullable Long timeEnd, @javax.annotation.Nullable Integer limit) throws ApiException {
        okhttp3.Call localVarCall = getMiscHotboardValidateBeforeCall(type, time, keyword, timeStart, timeEnd, limit, null);
     ...
     */
    public okhttp3.Call getMiscHotboardAsync(@javax.annotation.Nonnull String type, @javax.annotation.Nullable Long time, @javax.annotation.Nullable String keyword, @javax.annotation.Nullable Long timeStart, @javax.annotation.Nullable Long timeEnd, @javax.annotation.Nullable Integer limit, final ApiCallback<GetMiscHotboard200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMiscHotboardValidateBeforeCall(type, time, keyword, timeStart, timeEnd, limit, _callback);
        Type localVarReturnType = new TypeToken<GetMiscHotboard200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> 识别成功！直接返回识别结果和可能的备选项。 </td><td>  -  </td></tr>
     ...
     * @param full 使用这个参数可以获得完整的物流信息。但会消耗34积分/一次（不过缓存命中半价）。因为成本实在太贵了，否则非常非常亏说是 (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> 查询成功！直接返回快递的完整物流轨迹。 </td><td>  -  </td></tr>
     ...
     */
    public okhttp3.Call getMiscTrackingQueryCall(@javax.annotation.Nonnull String trackingNumber, @javax.annotation.Nullable String carrierCode, @javax.annotation.Nullable String phone, @javax.annotation.Nullable Boolean full, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getMiscTrackingQueryValidateBeforeCall(@javax.annotation.Nonnull String trackingNumber, @javax.annotation.Nullable String carrierCode, @javax.annotation.Nullable String phone, @javax.annotation.Nullable Boolean full, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'trackingNumber' is set
        if (trackingNumber == null) {
            throw new ApiException("Missing the required parameter 'trackingNumber' when calling getMiscTrackingQuery(Async)");
        }

        return getMiscTrackingQueryCall(trackingNumber, carrierCode, phone, full, _callback);
     ...
     */
    public GetMiscTrackingQuery200Response getMiscTrackingQuery(@javax.annotation.Nonnull String trackingNumber, @javax.annotation.Nullable String carrierCode, @javax.annotation.Nullable String phone, @javax.annotation.Nullable Boolean full) throws ApiException {
        ApiResponse<GetMiscTrackingQuery200Response> localVarResp = getMiscTrackingQueryWithHttpInfo(trackingNumber, carrierCode, phone, full);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetMiscTrackingQuery200Response> getMiscTrackingQueryWithHttpInfo(@javax.annotation.Nonnull String trackingNumber, @javax.annotation.Nullable String carrierCode, @javax.annotation.Nullable String phone, @javax.annotation.Nullable Boolean full) throws ApiException {
        okhttp3.Call localVarCall = getMiscTrackingQueryValidateBeforeCall(trackingNumber, carrierCode, phone, full, null);
     ...
     */
    public okhttp3.Call getMiscTrackingQueryAsync(@javax.annotation.Nonnull String trackingNumber, @javax.annotation.Nullable String carrierCode, @javax.annotation.Nullable String phone, @javax.annotation.Nullable Boolean full, final ApiCallback<GetMiscTrackingQuery200Response> _callback) throws ApiException {

        okhttp3.Call localVarCall = getMiscTrackingQueryValidateBeforeCall(trackingNumber, carrierCode, phone, full, _callback);
        Type localVarReturnType = new TypeToken<GetMiscTrackingQuery200Response>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param forecast 返回多天预报数据（最多7天），含每天的最高温度、最低温度、白天夜间天气、风向风力、日出日落等。 (optional)
     * @param hourly 返回逐小时预报（24小时），含温度、天气、风向风速、湿度、降水概率等。 (optional)
     * @param minutely 返回分钟级降水预报（仅国内城市），精确到2分钟。 (optional)
     ...
     * @param postMiscDateDiffRequest  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
