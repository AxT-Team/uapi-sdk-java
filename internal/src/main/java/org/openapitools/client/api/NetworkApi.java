...
public class NetworkApi {
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 400 </td><td> 请求参数无效。请检查 &#x60;domain&#x60; 参数是否提供且格式正确。 </td><td>  -  </td></tr>
        <tr><td> 404 </td><td> 未查询到备案信息。该域名可能没有在工信部备案，或者当前暂无可用结果。 </td><td>  -  </td></tr>
     </table>
     */
     ...
     * @param source 查询结果类型。不传时返回标准结果；如果设置为 &#x60;commercial&#x60;，将返回更完整的地理位置信息，但响应时间可能会稍长。 (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     * @http.response.details
     <table border="1">
       <caption>Response Details</caption>
        ...
        <tr><td> 502 </td><td> 暂时无法完成查询，请稍后重试。 </td><td>  -  </td></tr>
     </table>
     */
