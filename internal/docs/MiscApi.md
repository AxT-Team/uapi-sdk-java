...
# **getMiscHotboard**
> GetMiscHotboard200Response getMiscHotboard(type)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetMiscHotboard200Response result = apiInstance.getMiscHotboard(type);
      System.out.println(result);
    } catch (ApiException e) {
...
| Name | Type | Description  | Notes |
|------------- | ------------- | ------------- | -------------|
| **type** | **String**| 你想要查询的热榜平台。支持多种主流平台类型，详见下方[可选值](#可选值)表格。 | [enum: bilibili, acfun, weibo, zhihu, zhihu-daily, douyin, kuaishou, douban-movie, douban-group, tieba, hupu, miyoushe, ngabbs, v2ex, 52pojie, hostloc, coolapk, baidu, thepaper, toutiao, qq-news, sina, sina-news, netease-news, huxiu, ifanr, sspai, ithome, ithome-xijiayi, juejin, jianshu, guokr, 36kr, 51cto, csdn, nodeseek, hellogithub, lol, genshin, honkai, starrail, weread, weatheralarm, earthquake, history] |
...
> GetMiscTrackingQuery200Response getMiscTrackingQuery(trackingNumber, carrierCode)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      GetMiscTrackingQuery200Response result = apiInstance.getMiscTrackingQuery(trackingNumber, carrierCode);
      System.out.println(result);
    } catch (ApiException e) {
...
# **getMiscWeather**
> GetMiscWeather200Response getMiscWeather(city, adcode)
...
public class Example {
  public static void main(String[] args) {
    ...
    MiscApi apiInstance = new MiscApi(defaultClient);
    String city = "北京"; // String | 标准的城市名称，如 '北京', '上海市', '福田区'。请使用官方的省、市、区县行政区划名称。
    String adcode = "110000"; // String | 高德地图的6位数字城市编码。例如，北京市的Adcode是 '110000'。使用Adcode查询更准确、更快速。
    try {
      GetMiscWeather200Response result = apiInstance.getMiscWeather(city, adcode);
      System.out.println(result);
    } catch (ApiException e) {
