...
public class Example {
  public static void main(String[] args) {
    ...
    String sort = "0"; // String | 排序方式。支持 `0/time`（按时间）、`1/like`（按点赞）、`2/reply`（按回复数）、`3/hot/hottest/最热`（按最热）。默认为 `0/time`。
...
| **sort** | **String**| 排序方式。支持 &#x60;0/time&#x60;（按时间）、&#x60;1/like&#x60;（按点赞）、&#x60;2/reply&#x60;（按回复数）、&#x60;3/hot/hottest/最热&#x60;（按最热）。默认为 &#x60;0/time&#x60;。 | [optional] [enum: 0, time, 1, like, 2, reply, 3, hot, hottest, 最热] |
